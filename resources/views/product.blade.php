                                ...
                                <div class="rounded position-relative fruite-item">
                                    ...
                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                        ...
                                        <div class="text-center">
                                            <p class="text-center text-dark fs-5 fw-bold mb-0">Rp {{ $product->price }} / pcs</p>
                                            <a href="{{ route('product.show', $product->id) }}" class="btn border border-secondary rounded-pill px-3 text-primary text-center">Detail Produk</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
