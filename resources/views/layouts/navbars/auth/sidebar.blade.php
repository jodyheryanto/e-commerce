...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main" style="min-height: 100vh !important;">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('cms/banner') ? 'active' : '') }} " href="{{ route('cms.banner.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center {{ (Request::is('cms/banner') ? 'text-white' : 'text-dark') }}">
              <i class="fa-solid fa-images"></i>
            </div>
