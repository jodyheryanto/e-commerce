                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-primary dropdown-toggle text-white" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fas fa-user fa-md text-white"></i> <span class="text-white">{{ Auth::user()->name }}</span>
                                </button>
                            ...
                            @else
                            <a href="{{ route('register') }}" class="btn btn-primary py-2 px-4 rounded-pill text-white mx-3">
                                Register
                            </a>
                            <a href="{{ route('login') }}" class="btn btn-primary py-2 px-4 rounded-pill text-white">
                                Login
                            </a>
                            @endauth
                        </div>
