    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('Ubah Produk') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="{{ route('master-data.product.update', $product->id) }}" method="POST" enctype="multipart/form-data" role="form text-left">
                    @csrf
                    @method('PUT')
                    @if($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="@error('name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Masukkan Nama Produk" id="name" name="name" value="{{ $product->name }}">
                                        @error('name')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="mt-2">
                                    Image Saat Ini: <br>
                                    <img src="{{ asset('storage/' . $product->image) }}" alt="" style="width: 100px; height: 100px; object-fit: cover;">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('price')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="number" placeholder="Masukkan Harga Produk" id="price" name="price" min="0" value="{{ $product->price }}">
                                        @error('price')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('quantity')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="number" placeholder="Masukkan Stok Saat Ini Produk" id="quantity" name="quantity" min="0" value="{{ $product->quantity }}">
                                        @error('quantity')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="@error('description')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="about" rows="3" placeholder="Masukkan deskripsi banner" name="description">{{ $product->description }}</textarea>
                        </div>
                    </div>
