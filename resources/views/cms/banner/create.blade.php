    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('Buat Banner') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="{{ route('cms.banner.store') }}" method="POST" enctype="multipart/form-data" role="form text-left">
                    @csrf
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('title')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Nama Judul Banner" id="title" name="title">
                                        @error('title')
